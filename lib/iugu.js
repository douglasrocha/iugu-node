...
const IuguResource = require('./IuguResource');
...
const MarketPlace = require('./resources/MarketPlace');
const Plans = require('./resources/Plans');
const Subscriptions = require('./resources/Subscriptions');
const PaymentToken = require('./resources/PaymentToken');
const Transfers = require('./resources/Transfers');
const CustomerPaymentMethods = require('./resources/CustomerPaymentMethods');
...
export default class Iugu {
  ...
  initializeConstants () {
    ...
    this.PACKAGE_VERSION = package.version;
    this.USER_AGENT = {
